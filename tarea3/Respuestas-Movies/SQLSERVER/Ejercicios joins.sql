...
--1. Mostrar la lista de todas las peliculas indicando si esta en Idioma espa�ol o no
...
--3.Cuales son las 5 compa�ias productoras de peliculas que tiene mayor aceptacion (votos)
...
--5.Mostrar una lista con la cantidad de personas por departamento que cuenta cada compa�ia productora
...
--7.Listar los paises donde estan ubicas las compa�ias productoras
